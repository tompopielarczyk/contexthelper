...
export async function getSettings() {
  ...
  return {
    ...
    darkMode: syncData.darkMode
  };
}

export async function saveSettings(settings) {
  const { modelConfigs, actions, tooltipSettings, systemPrompt, darkMode } = settings;
  ...
  if (darkMode !== undefined) syncPayload.darkMode = darkMode;
